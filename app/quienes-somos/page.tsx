    ...
    <div className={styles.landingWrapper}>
      ...
      <section className={styles.aboutHeroWrapper}>
        <div className={styles.aboutHero}>
          ...
          <div className={styles.aboutHeroImage}>
            {/* Usamos el mockup o una ilustración genérica aquí */}
      ...
      <section className={styles.historySection}>
        <div className={styles.historyContainer}>
          ...
          <p className={styles.featureDesc} style={{ textAlign: 'center', marginBottom: '3rem', maxWidth: '600px', margin: '0 auto 3rem' }}>
